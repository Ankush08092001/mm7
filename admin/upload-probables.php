...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
            ...
            $stmt->bind_param("sisi", $title, $year, $file_name, $coming_soon);
...
<head>
    ...
    <title>Upload Probables - Admin</title>
...
<body>
    ...
    <main class="admin-dashboard">
        <div class="container">
            <h2>Upload Probables</h2>
            <?php if (!empty($message)): ?>
                <p><?php echo $message; ?></p>
            <?php endif; ?>
            <form action="upload-probables.php" method="post" enctype="multipart/form-data">
                ...
                <button type="submit" class="btn btn-primary">Upload Probable</button>
            </form>
