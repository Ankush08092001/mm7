...
// Get question and test IDs from URL
...
<head>
    ...
    <title>Edit Question - Admin Portal</title>
    ...
    <div class="admin-container">
        ...
        <main class="admin-content">
            <header class="admin-header">
                <h1 class="admin-header-title">Edit Question: <?php echo htmlspecialchars($test['title']); ?></h1>
                ...
                <form method="POST" class="admin-form">
                    <div class="form-group">
                        ...
                        <textarea name="question_text" id="question_text" rows="3" required
                                  class="form-control"><?php echo htmlspecialchars($question['question_text']); ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="question_type" id="question_type" required class="form-control">
                            ...
                            <option value="multiple_choice" <?php echo $question['question_type'] === 'multiple_choice' ? 'selected' : ''; ?>>
                                Multiple Choice
                            </option>
                            <option value="true_false" <?php echo $question['question_type'] === 'true_false' ? 'selected' : ''; ?>>
                                True/False
                            </option>
                            <option value="short_answer" <?php echo $question['question_type'] === 'short_answer' ? 'selected' : ''; ?>>
                                Short Answer
                            </option>
                        </select>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="correct_answer" class="form-control">
                                ...
                                <option value="<?php echo $index; ?>" 
                                        <?php echo $question['correct_answer'] == $index ? 'selected' : ''; ?>>
